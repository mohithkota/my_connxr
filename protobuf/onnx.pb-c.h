...
/* Generated from: protobuf/onnx.proto */

#ifndef PROTOBUF_C_protobuf_2fonnx_2eproto__INCLUDED
#define PROTOBUF_C_protobuf_2fonnx_2eproto__INCLUDED
...
typedef struct _Onnx__IntIntListEntryProto Onnx__IntIntListEntryProto;
typedef struct _Onnx__NodeDeviceConfigurationProto Onnx__NodeDeviceConfigurationProto;
typedef struct _Onnx__ShardingSpecProto Onnx__ShardingSpecProto;
typedef struct _Onnx__ShardedDimProto Onnx__ShardedDimProto;
typedef struct _Onnx__SimpleShardedDimProto Onnx__SimpleShardedDimProto;
typedef struct _Onnx__TrainingInfoProto Onnx__TrainingInfoProto;
typedef struct _Onnx__ModelProto Onnx__ModelProto;
typedef struct _Onnx__DeviceConfigurationProto Onnx__DeviceConfigurationProto;
 ...
 */
struct  _Onnx__IntIntListEntryProto
{
  ProtobufCMessage base;
 ...
 */
struct  _Onnx__NodeDeviceConfigurationProto
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  _Onnx__ShardingSpecProto
{
  ProtobufCMessage base;
  /*
   * This field MUST be present for this version of the IR.
...
typedef enum {
  ...
  ONNX__SIMPLE_SHARDED_DIM_PROTO__DIM_DIM_PARAM = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(ONNX__SIMPLE_SHARDED_DIM_PROTO__DIM)
 ...
 */
struct  _Onnx__SimpleShardedDimProto
{
  ProtobufCMessage base;
  /*
   * This field MUST be present for this version of the IR.
 ...
 */
struct  _Onnx__DeviceConfigurationProto
{
  ProtobufCMessage base;
  /*
   * This field MUST be present for this version of the IR.
...
#endif  /* PROTOBUF_C_protobuf_2fonnx_2eproto__INCLUDED */
