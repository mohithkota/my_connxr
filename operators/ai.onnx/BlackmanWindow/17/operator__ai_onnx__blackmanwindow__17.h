...
# ifndef OPERATOR_OPERATOR__AI_ONNX__BLACKMANWINDOW__17_H
# define OPERATOR_OPERATOR__AI_ONNX__BLACKMANWINDOW__17_H
...
/**
 * ai.onnx operator 'BlackmanWindow' version 17
 *
 ...
 * @since version 17
 *
 * @see github/workspace/onnx/defs/math/defs.cc:3228
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#BlackmanWindow
 */
...
extern operator_info info_operator__ai_onnx__blackmanwindow__17;

typedef struct {
// no attributes
} context_operator__ai_onnx__blackmanwindow__17;

operator_executer
resolve_operator__ai_onnx__blackmanwindow__17(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__blackmanwindow__17(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__blackmanwindow__17__T1_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__blackmanwindow__17__T1_tensor_int64(
    node_context *ctx
);
