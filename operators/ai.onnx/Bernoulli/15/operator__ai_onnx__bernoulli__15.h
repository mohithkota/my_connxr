...
# ifndef OPERATOR_OPERATOR__AI_ONNX__BERNOULLI__15_H
# define OPERATOR_OPERATOR__AI_ONNX__BERNOULLI__15_H
...
/**
 * ai.onnx operator 'Bernoulli' version 15
 *
 ...
 * @since version 15
 *
 * @see github/workspace/onnx/defs/generator/old.cc:23
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#Bernoulli
 */

operator_status
prepare_operator__ai_onnx__bernoulli__15(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__bernoulli__15;

typedef struct {
// no attributes
} context_operator__ai_onnx__bernoulli__15;
...
operator_status
execute_operator__ai_onnx__bernoulli__15(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__bernoulli__15__T1_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__bernoulli__15__T1_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__bernoulli__15__T1_tensor_float16(
    node_context *ctx
);
