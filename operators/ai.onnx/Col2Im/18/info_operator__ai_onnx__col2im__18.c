...
static
uint32_t
input_tensor_type_image_shape[] = {
ONNX__TENSOR_PROTO__DATA_TYPE__INT64
};

static
uint32_t
input_tensor_type_block_shape[] = {
ONNX__TENSOR_PROTO__DATA_TYPE__INT64
};
...
},
{
    ...
    .n_types     = 1,
    .types       = input_tensor_type_image_shape
},
{
    .name        = "block_shape",
    .optional    = false,
    ...
    .constraint  = "tensor(int64)",
    .n_types     = 1,
    .types       = input_tensor_type_block_shape
}
};
...
/* operator info */
operator_info
info_operator__ai_onnx__col2im__18 = {
    .name         = "Col2Im",
    .range_input  = { 3, 3 },
    .range_output = { 1, 1 },
    .n_attribute  = 3,
