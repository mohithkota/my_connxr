...
# ifndef OPERATOR_OPERATOR__AI_ONNX__REDUCELOGSUM__18_H
# define OPERATOR_OPERATOR__AI_ONNX__REDUCELOGSUM__18_H
...
/**
 * ai.onnx operator 'ReduceLogSum' version 18
 *
 ...
 * @since version 18
 *
 * @see github/workspace/onnx/defs/reduction/defs.cc:50
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#ReduceLogSum
 */

operator_status
prepare_operator__ai_onnx__reducelogsum__18(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__reducelogsum__18;

typedef struct {
// no attributes
} context_operator__ai_onnx__reducelogsum__18;
...
operator_status
execute_operator__ai_onnx__reducelogsum__18(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducelogsum__18__T_tensor_bfloat16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducelogsum__18__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducelogsum__18__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducelogsum__18__T_tensor_float16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducelogsum__18__T_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducelogsum__18__T_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducelogsum__18__T_tensor_uint32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducelogsum__18__T_tensor_uint64(
    node_context *ctx
);
