...
)
{
    ...
    // context_operator__ai_onnx__gelu__20 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__gelu__20));
    ...
    // ctx->executer = resolve_operator__ai_onnx__gelu__20(ctx);
