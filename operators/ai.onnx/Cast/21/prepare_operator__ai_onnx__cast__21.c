...
)
{
    ...
    // context_operator__ai_onnx__cast__21 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__cast__21));
    ...
    // ctx->executer = resolve_operator__ai_onnx__cast__21(ctx);
