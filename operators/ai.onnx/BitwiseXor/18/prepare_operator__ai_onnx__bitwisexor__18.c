...
)
{
    ...
    // context_operator__ai_onnx__bitwisexor__18 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__bitwisexor__18));
    ...
    // ctx->executer = resolve_operator__ai_onnx__bitwisexor__18(ctx);
