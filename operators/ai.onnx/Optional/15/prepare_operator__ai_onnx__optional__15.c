...
)
{
    ...
    // context_operator__ai_onnx__optional__15 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__optional__15));
    ...
    // ctx->executer = resolve_operator__ai_onnx__optional__15(ctx);
