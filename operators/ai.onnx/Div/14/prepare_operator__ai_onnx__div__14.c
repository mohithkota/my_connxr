...
)
{
    ...
    // context_operator__ai_onnx__div__14 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__div__14));
    ...
    // ctx->executer = resolve_operator__ai_onnx__div__14(ctx);
