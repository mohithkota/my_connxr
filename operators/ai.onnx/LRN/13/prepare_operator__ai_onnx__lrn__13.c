...
#include "operator__ai_onnx__lrn__13.h"
#include "tracing.h"
#include "utils.h"
...
)
{
    ...
    // context_operator__ai_onnx__lrn__13 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__lrn__13));
    ...
    // ctx->executer = resolve_operator__ai_onnx__lrn__13(ctx);
