...
# ifndef OPERATOR_OPERATOR__AI_ONNX__REDUCEMAX__20_H
# define OPERATOR_OPERATOR__AI_ONNX__REDUCEMAX__20_H
...
/**
 * ai.onnx operator 'ReduceMax' version 20
 *
 ...
 * @since version 20
 *
 * @see github/workspace/onnx/defs/reduction/defs.cc:15
...
extern operator_info info_operator__ai_onnx__reducemax__20;

typedef struct {
// no attributes
} context_operator__ai_onnx__reducemax__20;
...
operator_status
execute_operator__ai_onnx__reducemax__20(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducemax__20__T_tensor_bfloat16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducemax__20__T_tensor_bool(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducemax__20__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducemax__20__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducemax__20__T_tensor_float16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducemax__20__T_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducemax__20__T_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducemax__20__T_tensor_int8(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducemax__20__T_tensor_uint32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducemax__20__T_tensor_uint64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__reducemax__20__T_tensor_uint8(
    node_context *ctx
);
