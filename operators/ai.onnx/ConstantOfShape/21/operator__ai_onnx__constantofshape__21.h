...
# ifndef OPERATOR_OPERATOR__AI_ONNX__CONSTANTOFSHAPE__21_H
# define OPERATOR_OPERATOR__AI_ONNX__CONSTANTOFSHAPE__21_H
...
/**
 * ai.onnx operator 'ConstantOfShape' version 21
 *
 ...
 *                  tensor_uint16, tensor_uint32, tensor_tensor(uint4),
 ...
 * @since version 21
 *
 * @see github/workspace/onnx/defs/generator/defs.cc:67
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#ConstantOfShape
 */

operator_status
prepare_operator__ai_onnx__constantofshape__21(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__constantofshape__21;

typedef struct {
// no attributes
} context_operator__ai_onnx__constantofshape__21;

operator_executer
resolve_operator__ai_onnx__constantofshape__21(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__constantofshape__21(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__constantofshape__21__T1_tensor_int64(
    node_context *ctx
);
