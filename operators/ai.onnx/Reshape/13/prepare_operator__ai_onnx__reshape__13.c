...
)
{
    ...
    // context_operator__ai_onnx__reshape__13 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__reshape__13));
    ...
    // ctx->executer = resolve_operator__ai_onnx__reshape__13(ctx);
