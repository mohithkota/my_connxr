...
)
{
    ...
    // context_operator__ai_onnx__round__22 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__round__22));
    ...
    // ctx->executer = resolve_operator__ai_onnx__round__22(ctx);
