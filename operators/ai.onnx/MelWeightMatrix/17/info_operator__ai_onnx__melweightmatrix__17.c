...
static
uint32_t
input_tensor_type_num_mel_bins[] = {
...
static
uint32_t
input_tensor_type_lower_edge_hertz[] = {
...
static
uint32_t
input_tensor_type_upper_edge_hertz[] = {
ONNX__TENSOR_PROTO__DATA_TYPE__BFLOAT16,
ONNX__TENSOR_PROTO__DATA_TYPE__DOUBLE,
ONNX__TENSOR_PROTO__DATA_TYPE__FLOAT,
ONNX__TENSOR_PROTO__DATA_TYPE__FLOAT16
...
inputs[] = {
{
    ...
    .constraint  = "T1",
    .n_types     = 2,
    .types       = input_tensor_type_num_mel_bins
},
{
    .name        = "dft_length",
    .optional    = false,
...
},
{
    ...
    .constraint  = "T1",
    .n_types     = 2,
    .types       = input_tensor_type_sample_rate
},
{
    ...
    .constraint  = "T2",
    .n_types     = 4,
    .types       = input_tensor_type_lower_edge_hertz
},
{
    ...
    .constraint  = "T2",
    .n_types     = 4,
    .types       = input_tensor_type_upper_edge_hertz
}
};
...
/* operator info */
operator_info
info_operator__ai_onnx__melweightmatrix__17 = {
