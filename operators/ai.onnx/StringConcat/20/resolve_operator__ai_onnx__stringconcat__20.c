...
if (ctx->inputs[0]) {
    ...
    case ONNX__TENSOR_PROTO__DATA_TYPE__STRING: { executer = (operator_executer) &execute_operator__ai_onnx__stringconcat__20__T_tensor_string; break; }
    default: {
        fprintf(stderr, "no matching type for operator__ai_onnx__stringconcat__20 and constraint 'T' with type '%s' found!\n",operator_info_tensorType2str(T));
        break;
    }
}
}
