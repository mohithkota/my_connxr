...
# ifndef OPERATOR_OPERATOR__AI_ONNX__CONSTANT__21_H
# define OPERATOR_OPERATOR__AI_ONNX__CONSTANT__21_H
...
/**
 * ai.onnx operator 'Constant' version 21
 *
 ...
 * @since version 21
 *
 * @see github/workspace/onnx/defs/generator/defs.cc:18
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#Constant
 */

operator_status
prepare_operator__ai_onnx__constant__21(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__constant__21;

typedef struct {
// no attributes
} context_operator__ai_onnx__constant__21;

operator_executer
resolve_operator__ai_onnx__constant__21(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__constant__21(
    node_context *ctx
);
