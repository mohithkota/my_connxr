...
# ifndef OPERATOR_OPERATOR__AI_ONNX__MAXPOOL__22_H
# define OPERATOR_OPERATOR__AI_ONNX__MAXPOOL__22_H
...
/**
 * ai.onnx operator 'MaxPool' version 22
 *
 ...
 *                  tensor_float16, tensor_int8, tensor_uint8
 * 
 * Constraint I:
 ...
 * @since version 22
 *
 * @see github/workspace/onnx/defs/nn/defs.cc:338
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#MaxPool
 */

operator_status
prepare_operator__ai_onnx__maxpool__22(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__maxpool__22;

typedef struct {
// no attributes
} context_operator__ai_onnx__maxpool__22;
...
operator_status
execute_operator__ai_onnx__maxpool__22(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxpool__22__T_tensor_bfloat16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxpool__22__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxpool__22__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxpool__22__T_tensor_float16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxpool__22__T_tensor_int8(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__maxpool__22__T_tensor_uint8(
    node_context *ctx
);
