...
if (ctx->inputs[0]) {
    ...
    case ONNX__TENSOR_PROTO__DATA_TYPE__STRING: { executer = (operator_executer) &execute_operator__ai_onnx__regexfullmatch__20__T1_tensor_string; break; }
    default: {
        fprintf(stderr, "no matching type for operator__ai_onnx__regexfullmatch__20 and constraint 'T1' with type '%s' found!\n",operator_info_tensorType2str(T1));
        break;
    }
}
}
