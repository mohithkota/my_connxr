...
operator_status
prepare_operator__ai_onnx__lppool__18(
    node_context *ctx
)
{
    TRACE_ENTRY(1);
    ...
    // context_operator__ai_onnx__lppool__18 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__lppool__18));
    ...
    // ctx->executer = resolve_operator__ai_onnx__lppool__18(ctx);
