...
)
{
    ...
    // context_operator__ai_onnx__optionalhaselement__15 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__optionalhaselement__15));
    ...
    // ctx->executer = resolve_operator__ai_onnx__optionalhaselement__15(ctx);
