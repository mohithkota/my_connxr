...
#include "operator__ai_onnx__averagepool__19.h"
#include "tracing.h"
#include "utils.h"

operator_status
prepare_operator__ai_onnx__averagepool__19(
    node_context *ctx
)
{
    TRACE_ENTRY(1);
    ...
    // context_operator__ai_onnx__averagepool__19 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__averagepool__19));
    ...
    // ctx->executer = resolve_operator__ai_onnx__averagepool__19(ctx);
