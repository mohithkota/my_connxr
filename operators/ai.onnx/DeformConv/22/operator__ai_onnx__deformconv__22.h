...
# ifndef OPERATOR_OPERATOR__AI_ONNX__DEFORMCONV__22_H
# define OPERATOR_OPERATOR__AI_ONNX__DEFORMCONV__22_H
...
/**
 * ai.onnx operator 'DeformConv' version 22
 *
 ...
 * @since version 22
 *
 * @see github/workspace/onnx/defs/nn/defs.cc:1373
...
extern operator_info info_operator__ai_onnx__deformconv__22;

typedef struct {
// no attributes
} context_operator__ai_onnx__deformconv__22;
...
operator_status
execute_operator__ai_onnx__deformconv__22(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__deformconv__22__T_tensor_bfloat16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__deformconv__22__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__deformconv__22__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__deformconv__22__T_tensor_float16(
    node_context *ctx
);
