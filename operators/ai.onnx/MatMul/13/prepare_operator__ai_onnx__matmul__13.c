...
)
{
    ...
    // context_operator__ai_onnx__matmul__13 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__matmul__13));
    ...
    // ctx->executer = resolve_operator__ai_onnx__matmul__13(ctx);
