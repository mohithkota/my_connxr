...
if (ctx->inputs[0]) {
    ...
    case ONNX__TENSOR_PROTO__DATA_TYPE__UINT8: { executer = (operator_executer) &execute_operator__ai_onnx__imagedecoder__20__T1_tensor_uint8; break; }
    default: {
        fprintf(stderr, "no matching type for operator__ai_onnx__imagedecoder__20 and constraint 'T1' with type '%s' found!\n",operator_info_tensorType2str(T1));
        break;
    }
}
}
