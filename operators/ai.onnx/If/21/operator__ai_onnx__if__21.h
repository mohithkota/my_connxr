...
# ifndef OPERATOR_OPERATOR__AI_ONNX__IF__21_H
# define OPERATOR_OPERATOR__AI_ONNX__IF__21_H
...
/**
 * ai.onnx operator 'If' version 21
 *
 ...
 * @since version 21
 *
 * @see github/workspace/onnx/defs/controlflow/defs.cc:24
...
extern operator_info info_operator__ai_onnx__if__21;

typedef struct {
// no attributes
} context_operator__ai_onnx__if__21;

operator_executer
resolve_operator__ai_onnx__if__21(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__if__21(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__if__21__B_tensor_bool(
    node_context *ctx
);
