...
# ifndef OPERATOR_OPERATOR__AI_ONNX__IF__13_H
# define OPERATOR_OPERATOR__AI_ONNX__IF__13_H
...
/**
 * ai.onnx operator 'If' version 13
 *
 ...
 * @since version 13
 *
 * @see github/workspace/onnx/defs/controlflow/old.cc:2108
...
extern operator_info info_operator__ai_onnx__if__13;

typedef struct {
// no attributes
} context_operator__ai_onnx__if__13;

operator_executer
resolve_operator__ai_onnx__if__13(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__if__13(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__if__13__B_tensor_bool(
    node_context *ctx
);
