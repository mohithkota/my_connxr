...
# ifndef OPERATOR_OPERATOR__AI_ONNX__IF__16_H
# define OPERATOR_OPERATOR__AI_ONNX__IF__16_H
...
/**
 * ai.onnx operator 'If' version 16
 *
 ...
 * @since version 16
 *
 * @see github/workspace/onnx/defs/controlflow/old.cc:79
...
extern operator_info info_operator__ai_onnx__if__16;

typedef struct {
// no attributes
} context_operator__ai_onnx__if__16;

operator_executer
resolve_operator__ai_onnx__if__16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__if__16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__if__16__B_tensor_bool(
    node_context *ctx
);
