...
# ifndef OPERATOR_OPERATOR__AI_ONNX_ML__TREEENSEMBLEREGRESSOR__5_H
# define OPERATOR_OPERATOR__AI_ONNX_ML__TREEENSEMBLEREGRESSOR__5_H
...
/**
 * ai.onnx.ml operator 'TreeEnsembleRegressor' version 5
 *
 ...
 * 
 * Attribute TENSOR target_weights_as_tensor (optional):
 *   The weight for each target
 *
 * @since version 5
 *
 * @see github/workspace/onnx/defs/traditionalml/defs.cc:917
...
extern operator_info info_operator__ai_onnx_ml__treeensembleregressor__5;

typedef struct {
// no attributes
} context_operator__ai_onnx_ml__treeensembleregressor__5;

operator_executer
resolve_operator__ai_onnx_ml__treeensembleregressor__5(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx_ml__treeensembleregressor__5(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx_ml__treeensembleregressor__5__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx_ml__treeensembleregressor__5__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx_ml__treeensembleregressor__5__T_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx_ml__treeensembleregressor__5__T_tensor_int64(
    node_context *ctx
);
