...
#include "operator__ai_onnx__regexfullmatch__20.h"
#include "tracing.h"
#include "utils.h"
...
)
{
    ...
    // Onnx__AttributeProto *a_pattern = searchAttributeNyName(ctx->onnx_node->n_attribute,ctx->onnx_node->attribute,"pattern");

    // TRACE_ATTRIBUTE(2, a_pattern, a_pattern);
    ...
    // context_operator__ai_onnx__regexfullmatch__20 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__regexfullmatch__20));
    // TRACE_FATAL(0 , !op_ctx, "could not allocate executer_context");

    

    TRACE_VAR(2, true, op_ctx->pattern, "\"%s\"");
    ...
    // ctx->executer = resolve_operator__ai_onnx__regexfullmatch__20(ctx);
