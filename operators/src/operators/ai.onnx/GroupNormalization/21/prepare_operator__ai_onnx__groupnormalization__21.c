...
)
{
    ...
    // context_operator__ai_onnx__groupnormalization__21 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__groupnormalization__21));
    ...
    // ctx->executer = resolve_operator__ai_onnx__groupnormalization__21(ctx);
