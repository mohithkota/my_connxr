...
# ifndef OPERATOR_OPERATOR__AI_ONNX__ROIALIGN__22_H
# define OPERATOR_OPERATOR__AI_ONNX__ROIALIGN__22_H
...
/**
 * ai.onnx operator 'RoiAlign' version 22
 *
 ...
 * @since version 22
 *
 * @see github/workspace/onnx/defs/object_detection/defs.cc:24
...
extern operator_info info_operator__ai_onnx__roialign__22;

typedef struct {
// no attributes
} context_operator__ai_onnx__roialign__22;
...
operator_status
execute_operator__ai_onnx__roialign__22(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__roialign__22__T1_tensor_bfloat16__T2_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__roialign__22__T1_tensor_double__T2_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__roialign__22__T1_tensor_float__T2_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__roialign__22__T1_tensor_float16__T2_tensor_int64(
    node_context *ctx
);
