...
)
{
    ...
    // context_operator__ai_onnx__pad__13 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__pad__13));
    ...
    // ctx->executer = resolve_operator__ai_onnx__pad__13(ctx);
