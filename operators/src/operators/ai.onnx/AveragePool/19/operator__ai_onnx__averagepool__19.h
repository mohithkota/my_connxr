...
# ifndef OPERATOR_OPERATOR__AI_ONNX__AVERAGEPOOL__19_H
# define OPERATOR_OPERATOR__AI_ONNX__AVERAGEPOOL__19_H
...
/**
 * ai.onnx operator 'AveragePool' version 19
 *
 ...
 * @since version 19
 *
 * @see github/workspace/onnx/defs/nn/old.cc:1487
...
extern operator_info info_operator__ai_onnx__averagepool__19;

typedef struct {
// no attributes
} context_operator__ai_onnx__averagepool__19;
...
operator_status
execute_operator__ai_onnx__averagepool__19(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__averagepool__19__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__averagepool__19__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__averagepool__19__T_tensor_float16(
    node_context *ctx
);
