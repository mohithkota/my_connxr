...
# ifndef OPERATOR_OPERATOR__AI_ONNX__SCAN__21_H
# define OPERATOR_OPERATOR__AI_ONNX__SCAN__21_H
...
/**
 * ai.onnx operator 'Scan' version 21
 *
 ...
 * @since version 21
 *
 * @see github/workspace/onnx/defs/controlflow/defs.cc:386
...
extern operator_info info_operator__ai_onnx__scan__21;

typedef struct {
// no attributes
} context_operator__ai_onnx__scan__21;
...
operator_status
execute_operator__ai_onnx__scan__21(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_bfloat16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_bool(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_complex128(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_complex64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_float16(
    node_context *ctx
);
...
operator_status
execute_operator__ai_onnx__scan__21__V_tensor_tensor(float8e4m3fnuz)(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_tensor(float8e5m2)(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_tensor(float8e5m2fnuz)(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_int16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_tensor(int4)(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_int8(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_string(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_uint16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_uint32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_tensor(uint4)(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_uint64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__21__V_tensor_uint8(
    node_context *ctx
);
