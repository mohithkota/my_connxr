...
# ifndef OPERATOR_OPERATOR__AI_ONNX__SCAN__16_H
# define OPERATOR_OPERATOR__AI_ONNX__SCAN__16_H
...
/**
 * ai.onnx operator 'Scan' version 16
 *
 ...
 * @since version 16
 *
 * @see github/workspace/onnx/defs/controlflow/old.cc:562
...
extern operator_info info_operator__ai_onnx__scan__16;

typedef struct {
// no attributes
} context_operator__ai_onnx__scan__16;
...
operator_status
execute_operator__ai_onnx__scan__16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_bfloat16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_bool(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_complex128(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_complex64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_float16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_int16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_int8(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_string(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_uint16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_uint32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_uint64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__scan__16__V_tensor_uint8(
    node_context *ctx
);
