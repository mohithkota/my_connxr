...
)
{
    ...
    // context_operator__ai_onnx__stft__17 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__stft__17));
    ...
    // ctx->executer = resolve_operator__ai_onnx__stft__17(ctx);
