...
static
uint32_t
input_tensor_type_additional_inputs[] = {
ONNX__TENSOR_PROTO__DATA_TYPE__BOOL,
ONNX__TENSOR_PROTO__DATA_TYPE__COMPLEX128,
ONNX__TENSOR_PROTO__DATA_TYPE__COMPLEX64,
ONNX__TENSOR_PROTO__DATA_TYPE__DOUBLE,
...
},
{
    ...
    .constraint  = "V",
    .n_types     = 30,
    .types       = input_tensor_type_additional_inputs
}
};
...
static
uint32_t
output_tensor_type_out_sequence[] = {
ONNX__TENSOR_PROTO__DATA_TYPE__BOOL,
ONNX__TENSOR_PROTO__DATA_TYPE__COMPLEX128,
ONNX__TENSOR_PROTO__DATA_TYPE__COMPLEX64,
ONNX__TENSOR_PROTO__DATA_TYPE__DOUBLE,
...
outputs[] = {
{
    ...
    .constraint  = "S",
    .n_types     = 15,
    .types       = output_tensor_type_out_sequence
}
};
...
/* operator info */
operator_info
info_operator__ai_onnx__sequencemap__17 = {
    .name         = "SequenceMap",
