...
# ifndef OPERATOR_OPERATOR__AI_ONNX__SOFTMAXCROSSENTROPYLOSS__13_H
# define OPERATOR_OPERATOR__AI_ONNX__SOFTMAXCROSSENTROPYLOSS__13_H
...
/**
 * ai.onnx operator 'SoftmaxCrossEntropyLoss' version 13
 *
 ...
 * @since version 13
 *
 * @see github/workspace/onnx/defs/math/defs.cc:2787
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#SoftmaxCrossEntropyLoss
 */

operator_status
prepare_operator__ai_onnx__softmaxcrossentropyloss__13(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__softmaxcrossentropyloss__13;

typedef struct {
// no attributes
} context_operator__ai_onnx__softmaxcrossentropyloss__13;
...
operator_status
execute_operator__ai_onnx__softmaxcrossentropyloss__13(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__softmaxcrossentropyloss__13__T_tensor_bfloat16__Tind_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__softmaxcrossentropyloss__13__T_tensor_bfloat16__Tind_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__softmaxcrossentropyloss__13__T_tensor_double__Tind_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__softmaxcrossentropyloss__13__T_tensor_double__Tind_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__softmaxcrossentropyloss__13__T_tensor_float__Tind_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__softmaxcrossentropyloss__13__T_tensor_float__Tind_tensor_int64(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__softmaxcrossentropyloss__13__T_tensor_float16__Tind_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__softmaxcrossentropyloss__13__T_tensor_float16__Tind_tensor_int64(
    node_context *ctx
);
