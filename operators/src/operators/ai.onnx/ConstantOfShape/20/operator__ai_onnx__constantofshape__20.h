...
# ifndef OPERATOR_OPERATOR__AI_ONNX__CONSTANTOFSHAPE__20_H
# define OPERATOR_OPERATOR__AI_ONNX__CONSTANTOFSHAPE__20_H
...
/**
 * ai.onnx operator 'ConstantOfShape' version 20
 *
 ...
 *                  tensor_int64, tensor_int8, tensor_uint16, tensor_uint32,
 ...
 * @since version 20
 *
 * @see github/workspace/onnx/defs/generator/old.cc:649
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#ConstantOfShape
 */

operator_status
prepare_operator__ai_onnx__constantofshape__20(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__constantofshape__20;

typedef struct {
// no attributes
} context_operator__ai_onnx__constantofshape__20;

operator_executer
resolve_operator__ai_onnx__constantofshape__20(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__constantofshape__20(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__constantofshape__20__T1_tensor_int64(
    node_context *ctx
);
