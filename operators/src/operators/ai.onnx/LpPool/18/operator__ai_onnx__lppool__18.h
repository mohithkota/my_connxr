...
# ifndef OPERATOR_OPERATOR__AI_ONNX__LPPOOL__18_H
# define OPERATOR_OPERATOR__AI_ONNX__LPPOOL__18_H
...
/**
 * ai.onnx operator 'LpPool' version 18
 *
 ...
 * @since version 18
 *
 * @see github/workspace/onnx/defs/nn/old.cc:1270
...
extern operator_info info_operator__ai_onnx__lppool__18;

typedef struct {
// no attributes
} context_operator__ai_onnx__lppool__18;
...
operator_status
execute_operator__ai_onnx__lppool__18(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__lppool__18__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__lppool__18__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__lppool__18__T_tensor_float16(
    node_context *ctx
);
