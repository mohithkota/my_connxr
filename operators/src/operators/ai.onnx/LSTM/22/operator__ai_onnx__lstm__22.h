...
# ifndef OPERATOR_OPERATOR__AI_ONNX__LSTM__22_H
# define OPERATOR_OPERATOR__AI_ONNX__LSTM__22_H
...
/**
 * ai.onnx operator 'LSTM' version 22
 *
 ...
 *   Y_c.shape = [num_directions, batch_size, hidden_size]. If 1, the following
 *   shapes are expected: X.shape = [batch_size, seq_length, input_size],
 *   Y.shape = [batch_size, seq_length, num_directions, hidden_size],
 *   initial_h.shape = Y_h.shape = initial_c.shape = Y_c.shape = [batch_size,
 *   num_directions, hidden_size].
 *
 * @since version 22
 *
 * @see github/workspace/onnx/defs/rnn/defs.cc:423
...
extern operator_info info_operator__ai_onnx__lstm__22;

typedef struct {
// no attributes
} context_operator__ai_onnx__lstm__22;
