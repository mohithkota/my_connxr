...
# ifndef OPERATOR_OPERATOR__AI_ONNX__HANNWINDOW__17_H
# define OPERATOR_OPERATOR__AI_ONNX__HANNWINDOW__17_H
...
/**
 * ai.onnx operator 'HannWindow' version 17
 *
 ...
 * @since version 17
 *
 * @see github/workspace/onnx/defs/math/defs.cc:3152
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#HannWindow
 */
...
extern operator_info info_operator__ai_onnx__hannwindow__17;

typedef struct {
// no attributes
} context_operator__ai_onnx__hannwindow__17;

operator_executer
resolve_operator__ai_onnx__hannwindow__17(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__hannwindow__17(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__hannwindow__17__T1_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__hannwindow__17__T1_tensor_int64(
    node_context *ctx
);
