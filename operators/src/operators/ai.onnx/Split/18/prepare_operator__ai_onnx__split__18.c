...
)
{
    ...
    // Onnx__AttributeProto *a_num_outputs = searchAttributeNyName(ctx->onnx_node->n_attribute,ctx->onnx_node->attribute,"num_outputs");

    // TRACE_ATTRIBUTE(2, a_axis, a_axis);
    // TRACE_ATTRIBUTE(2, a_num_outputs, a_num_outputs);
    ...
    // context_operator__ai_onnx__split__18 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__split__18));
    // TRACE_FATAL(0 , !op_ctx, "could not allocate executer_context");

    

    TRACE_VAR(2, true, op_ctx->axis, "%" PRId64);
    TRACE_VAR(2, true, op_ctx->num_outputs, "%" PRId64);
    ...
    // ctx->executer = resolve_operator__ai_onnx__split__18(ctx);
