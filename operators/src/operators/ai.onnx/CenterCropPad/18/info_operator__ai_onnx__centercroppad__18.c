...
inputs[] = {
{
    ...
    .constraint  = "T",
    .n_types     = 16,
    .types       = input_tensor_type_input_data
},
{
    .name        = "shape",
    .optional    = false,
...
static
uint32_t
output_tensor_type_output_data[] = {
ONNX__TENSOR_PROTO__DATA_TYPE__BFLOAT16,
ONNX__TENSOR_PROTO__DATA_TYPE__BOOL,
ONNX__TENSOR_PROTO__DATA_TYPE__COMPLEX128,
ONNX__TENSOR_PROTO__DATA_TYPE__COMPLEX64,
...
outputs[] = {
{
    ...
    .constraint  = "T",
    .n_types     = 16,
    .types       = output_tensor_type_output_data
}
};
...
/* operator info */
operator_info
info_operator__ai_onnx__centercroppad__18 = {
    .name         = "CenterCropPad",
    .range_input  = { 2, 2 },
    .range_output = { 1, 1 },
    .n_attribute  = 1,
