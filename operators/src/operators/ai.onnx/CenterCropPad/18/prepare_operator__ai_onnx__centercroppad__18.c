...
)
{
    ...
    // context_operator__ai_onnx__centercroppad__18 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__centercroppad__18));
    ...
    // mallocTensorData(o_output_data);
    ...
    // ctx->executer = resolve_operator__ai_onnx__centercroppad__18(ctx);
