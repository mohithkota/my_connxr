...
# ifndef OPERATOR_OPERATOR__AI_ONNX__CONV__22_H
# define OPERATOR_OPERATOR__AI_ONNX__CONV__22_H
...
/**
 * ai.onnx operator 'Conv' version 22
 *
 ...
 *   DATA_CHANNEL and the number of feature maps M should be a multiple of the
 *   number of groups G.
 *   Allowed Types: tensor_bfloat16, tensor_double, tensor_float,
 *                  tensor_float16
 * 
 ...
 * @since version 22
 *
 * @see github/workspace/onnx/defs/nn/defs.cc:833
 * @see https://github.com/onnx/onnx/blob/master/docs/Operators.md#Conv
 */

operator_status
prepare_operator__ai_onnx__conv__22(
    node_context *ctx
);

extern operator_info info_operator__ai_onnx__conv__22;

typedef struct {
// no attributes
} context_operator__ai_onnx__conv__22;
...
operator_status
execute_operator__ai_onnx__conv__22(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__conv__22__T_tensor_bfloat16(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__conv__22__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__conv__22__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx__conv__22__T_tensor_float16(
    node_context *ctx
);
