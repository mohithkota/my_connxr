...
)
{
    ...
    // context_operator__ai_onnx__gridsample__16 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__gridsample__16));
    ...
    // ctx->executer = resolve_operator__ai_onnx__gridsample__16(ctx);
