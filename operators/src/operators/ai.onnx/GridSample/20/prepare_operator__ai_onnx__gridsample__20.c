...
)
{
    ...
    // context_operator__ai_onnx__gridsample__20 *op_ctx = NULL;
    // op_ctx = malloc(sizeof(context_operator__ai_onnx__gridsample__20));
    ...
    // ctx->executer = resolve_operator__ai_onnx__gridsample__20(ctx);
