...
)
{
    ...
    TRACE_TENSOR(2, true, base_values_as_tensor);
    ...
    TRACE_TENSOR(2, true, class_weights_as_tensor);
    ...
    TRACE_TENSOR(2, true, nodes_hitrates_as_tensor);
    ...
    TRACE_TENSOR(2, true, nodes_values_as_tensor);
