...
# ifndef OPERATOR_OPERATOR__AI_ONNX_ML__TREEENSEMBLECLASSIFIER__3_H
# define OPERATOR_OPERATOR__AI_ONNX_ML__TREEENSEMBLECLASSIFIER__3_H
...
/**
 * ai.onnx.ml operator 'TreeEnsembleClassifier' version 3
 *
 ...
 * @since version 3
 *
 * @see github/workspace/onnx/defs/traditionalml/old.cc:175
...
extern operator_info info_operator__ai_onnx_ml__treeensembleclassifier__3;

typedef struct {
// no attributes
} context_operator__ai_onnx_ml__treeensembleclassifier__3;
...
operator_status
execute_operator__ai_onnx_ml__treeensembleclassifier__3(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx_ml__treeensembleclassifier__3__T1_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx_ml__treeensembleclassifier__3__T1_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx_ml__treeensembleclassifier__3__T1_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx_ml__treeensembleclassifier__3__T1_tensor_int64(
    node_context *ctx
);
