...
# ifndef OPERATOR_OPERATOR__AI_ONNX_ML__TREEENSEMBLEREGRESSOR__3_H
# define OPERATOR_OPERATOR__AI_ONNX_ML__TREEENSEMBLEREGRESSOR__3_H
...
/**
 * ai.onnx.ml operator 'TreeEnsembleRegressor' version 3
 *
 ...
 * @since version 3
 *
 * @see github/workspace/onnx/defs/traditionalml/old.cc:422
...
extern operator_info info_operator__ai_onnx_ml__treeensembleregressor__3;

typedef struct {
// no attributes
} context_operator__ai_onnx_ml__treeensembleregressor__3;

operator_executer
resolve_operator__ai_onnx_ml__treeensembleregressor__3(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx_ml__treeensembleregressor__3(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx_ml__treeensembleregressor__3__T_tensor_double(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx_ml__treeensembleregressor__3__T_tensor_float(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx_ml__treeensembleregressor__3__T_tensor_int32(
    node_context *ctx
);

operator_status
execute_operator__ai_onnx_ml__treeensembleregressor__3__T_tensor_int64(
    node_context *ctx
);
